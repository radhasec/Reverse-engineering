...
![Reverse engineering 32 and 64 bits binaries with Radare2 - 1](https://web.archive.org/web/20200606161242im_/https://artik.blue/assets/images/radare2/radare2_1.png)
...
[Wanna show your support to this course? Follow me in Twitter! @artikblue](https://web.archive.org/web/20200606161242/https://artik.blue/www.twitter.com/artikblue) If people show interest I’ll post more content :)
...
And if you wish to use it on windows you can [download the windows setup](https://web.archive.org/web/20200606161242/https://rada.re/r/down.html) from its website.
...
The part that we’ll have to focus on here starts with push str.Hello\_\_World and then the call to printf. In 32 bits systems the way of passing parameters to functions consists of pushing those parameters to the stack and then executing a call operation on the address of the function. So something like “printf(a);” in C would be a “push a; call printf” in asm. [So what about the rest of the code?](https://web.archive.org/web/20200606161242/https://stackoverflow.com/questions/36046201/why-do-we-push-ebp-and-mov-ebp-esp-in-the-callee-in-assembly) Well, the first part of the code is related establishing a new [stack frame](https://web.archive.org/web/20200606161242/http://www.cs.uwm.edu/classes/cs315/Bacon/Lecture/HTML/ch10s07.html) and a stack frame is nothing more than a section of the code that will contain local variables of the function, arguments passed and values such as that. The end of the code
...
[reversing](https://web.archive.org/web/20200606161242/https://artik.blue/tag/reversing/) [c](https://web.archive.org/web/20200606161242/https://artik.blue/tag/c/) [radare](https://web.archive.org/web/20200606161242/https://artik.blue/tag/radare/)
